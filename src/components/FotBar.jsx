  ...
  return (
    <div className="flex w-full max-w-[1480px]">
      <footer className="flex flex-[6] flex-wrap justify-between gap-3 md:h-[204px] md:gap-0">
        {footerLinks.map((nav) => (
          <div key={nav.title}>
            <div className="flex w-full max-w-[10px] flex-col gap-2 md:h-[204px]">
            ...
            <div className="flex items-center justify-between">
              {nav.links.map((link, index) => (
                <div
                  ...
                  className="flex h-[56px] w-[56px] items-center justify-center rounded-lg border-[1px] border-[#262626] bg-[#1A1A1A]"
                >
                  <img
                    src={link.icon}
                    alt="icon"
